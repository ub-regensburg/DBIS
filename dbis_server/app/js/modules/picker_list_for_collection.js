 ...
 */
import './picker_list_for_collection.scss';
...
class PickerList
{
    ...
    async fetchEntries(options = {}) {
        ...
        if (!options.url) {
            ...
            if (options.all) {
                url.searchParams.set("all", options.all);
            }
        }
